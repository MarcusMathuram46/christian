...
function Enquiry() {
  ...
  useEffect(() => {
    const fetchEnquiries = async () => {
      setLoadingEnquiries(true) // Start loading
      try {
        ...
        setLoadingEnquiries(false) // Stop loading
      }
    }
    fetchEnquiries()
  }, [])
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      await axios.post('http://localhost:4000/api/enquiry', {
        name,
        email,
        mobile,
        subject,
      ...
      if (error.response && error.response.data) {
        if (
          ...
          'Enquiry with this name and email already exists'
        ) {
          alert(
            'You have already submitted an enquiry with this name and email. Please contact support.'
          )
        } else {
    ...
    <div className="bg-white">
      <div id="enquiry" className="enquiry-container">
        ...
        <p className="enquiry-description">
          If you have any queries, please contact us. We’d love to hear from
          you!
        </p>
            ...
            <form onSubmit={handleSubmit} className="enquiry-form">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="All-Types-of-Insurance">
